...
const HarassmentNext = {
    ...
    numComplainants: { 1: "output", 2: "output", default: "numRespondents" },
    numRespondents: { 1: "output", 2: "output", default: "numAllegations" },
    numAllegations: { 1: "output", 2: "output", default: "discussion" },
    discussion: { 0: "output", default: "inWorkplace" },
    inWorkplace: { 1: "outsideDismissed", default: "investigationProcess" },
    outsideDismissed: { 1: "output", default: "investigationProcess" },
    investigationProcess: { 1: "output", 2: "output", default: "inUnion" },
    inUnion: { 0: "unionRepresentation", default: "invOrganizer" },
    inUnionInvestigation: { 0: "unionRepresentation", default: "invOrganizer" },
    unionRepresentation: { 1: "output", default: "unionRepresentationBlockedEmp" },
    unionRepresentationBlockedEmp: { 0: "output", default: "unionRepresentationBlockedInv" },
    unionRepresentationBlockedInv: { 0: "output", default: "unionRespondent" },
    unionRespondent: { 0: "unionSameRep", default: "unionLocation" },
    unionSameRep: { 0: "unionSameRepConsent", default: "unionLocation" },
    unionSameRepConsent: { 1: "output", default: "unionLocation" },
    unionLocation: { 6: "output", default: "invOrganizer" },
    ...
    invOrganizerOtherExt: { default: "invExternal" },
    invInt: { default: "output" }
}
